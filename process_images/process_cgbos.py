...
DESCRIPTION
======
This performs color gradient BOS method, along with some preprocessing and 
postprocessing.
...
# blur image to remove CG-BOS artifacts
sigma = wavelength
fIout = scipy.ndimage.filters.gaussian_filter(Idiff, sigma, order=0)
display_image(fIout)
...
if saveChoice:
    outputFilename = 'cgBOS_results_' + time.strftime("%Y-%m-%d") +'.jpg'
